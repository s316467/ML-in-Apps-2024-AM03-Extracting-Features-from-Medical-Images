...
def extract_patches(image_path, patches_path, roi_coords, patch_size=512, mag_level=1):
...
def extract_all(ds_path, patches_path, patch_size=512, mag_level=1):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to save patches and ROI",
    )
    parser.add_argument(
        "--patch_size",
        type=int,
