...
if __name__ == '__main__':
    ...
    net = BYOL(resnet, image_size=IMAGE_SIZE, hidden_layer="avgpool", **byol_args)
    ...
    if checkpoints:
            ...
            new_state_dict = {f"net.{key}": value for key, value in new_state_dict.items()}
    ...
    with torch.no_grad():
        for data, labels in tqdm(dataloader):
            projection, embedding = net(data, return_embedding = True)
